...
export const CHARACTERS = [
  ...
  {
    id: 'baron',
    name: 'Baron Von Bluff',
    avatar: '🎩',
    color: '#9b59b6',
    blurb: 'A theatrical aristocrat. Loud, loose, and convinced he is winning.',
    profile: { aggression: 0.85, tightness: 0.28, bluff: 0.5, tilt: 0.45 },
    lines: {
      raise: ['I RAISE, naturally!', 'Tremble, peasants — a raise!'],
      call: ['I shall indulge you.', 'A trifling sum. Call.'],
      fold: ['Bah! Beneath me.', 'I withdraw, with dignity.'],
      win: ['As a baron should!', 'Bow before the cards!'],
      bigWin: ['MAGNIFICENT! All mine!'],
      lose: ['An outrage! Preposterous!'],
      bluffCaught: ['You... you saw through me?!'],
    },
    power: null,
  },
  {
